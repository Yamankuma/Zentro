...
function ProductPage() {
    return ( 
        ...
        <p className='mt-5 mb-5 p-5 text-center text-muted fs-5'>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>Zerodha.tech</a>  blog.</p>
        <Universe />
        </>
     );
}
